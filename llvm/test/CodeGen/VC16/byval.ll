...
; VC16I-NEXT:    lui a2, %hiu(foo+8)
; VC16I-NEXT:    lw a2, %lo(foo+8)(a2)
; VC16I-NEXT:    sw a2, 8(sp)
; VC16I-NEXT:    lui a2, %hiu(foo+6)
; VC16I-NEXT:    lw a2, %lo(foo+6)(a2)
; VC16I-NEXT:    sw a2, 6(sp)
; VC16I-NEXT:    lui a2, %hiu(foo+4)
; VC16I-NEXT:    lw a2, %lo(foo+4)(a2)
; VC16I-NEXT:    sw a2, 4(sp)
; VC16I-NEXT:    lui a2, %hiu(foo+2)
; VC16I-NEXT:    lw a2, %lo(foo+2)(a2)
; VC16I-NEXT:    sw a2, 2(sp)
; VC16I-NEXT:    lui a2, %hiu(foo)
; VC16I-NEXT:    lw a2, %lo(foo)(a2)
